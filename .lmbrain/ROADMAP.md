...
- `specs`: [SPEC-005, SPEC-006, SPEC-007, SPEC-008, SPEC-009, SPEC-010, SPEC-011, SPEC-012, SPEC-013, SPEC-014, SPEC-015, SPEC-016, SPEC-017, SPEC-018, SPEC-019, SPEC-020, SPEC-021] - tutte done
- `risks`: [complessità del consenso, taratura curve emissione/burn]
- `nota`: **Nove spec `done`.** Con [SPEC-013] e' completo il lavoro che doveva precedere la devnet: regole di consenso scritte, applicate e verificate; verificatore di firme misurato contro un oracolo upstream; legame fra identita e indirizzo di rete ne pubblicato ne ricalcolabile. [SPEC-014] e' redatta e raggruppa i due cambiamenti breaking dell'API di `coblox-core`, da fare prima del primo chiamante del verificatore. Resta poi la parte che la milestone nomina: devnet BFT, light client con prove Merkle, mint & burn. [SPEC-015] non appartiene all'esito di questa milestone ed e assegnata qui perche e la corrente: e la guida pubblica al funzionamento, artefatto vivo che conviene cominciare ora invece che a M-08, perche cominciarlo tardi significa scriverlo su un sistema che nessuno ricorda piu di aver progettato.
